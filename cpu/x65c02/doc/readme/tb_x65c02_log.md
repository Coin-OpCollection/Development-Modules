# x65c02 Regression Log

Full output of the `tb_x65c02` testbench (727 tests across 47 sections). See [README.md](../../README.md#design-verification) for the section-by-section description.

```
=============================================================
  x65c02 Comprehensive Testbench
  Reference: MOS Technology MCS6500 Hardware Manual
             Rockwell R65C02 / R65C102 / R65C112 Datasheet
=============================================================
...
PASS: JMP ind timing (CMOS 6 cyc) = 6 cycles
PASS: JMP ($0030): PC = $1522 = 00001522
PASS: JMP ind timing 2 (CMOS 6 cyc) = 6 cycles
PASS: JMP ($0100): PC = $1744 = 00001744
PASS: JMP ($xxFF) timing (CMOS 6 cyc) = 6 cycles
PASS: JMP ($00FF) CMOS-fixed: PC = $4477 = 00004477
...
PASS: BRA fwd no-cross timing = 3 cycles
PASS: BRA +5: PC = $1107 = 00001107
PASS: BRA flags-all-1 timing = 3 cycles
PASS: BRA +10 (flags=$FF): PC = $110C = 0000110c
PASS: BRA back no-cross timing = 3 cycles
PASS: BRA -2: PC = $1110 = 00001110
PASS: BRA fwd cross timing = 4 cycles
PASS: BRA +32 cross: PC = $1112 = 00001112
PASS: BRA back cross timing = 4 cycles
PASS: BRA -32 cross: PC = $10F2 = 000010f2

=== SECTION 38: CMOS INC A / DEC A ===

PASS: INC A timing = 2 cycles
PASS: INC A: $0F -> $10 = 00000010
PASS: INC A N=0 = 00000000
PASS: INC A Z=0 = 00000000
PASS: INC A: $FF -> $00 = 00000000
PASS: INC A wrap Z=1 = 00000001
PASS: INC A: $7F -> $80 = 00000080
PASS: INC A neg N=1 = 00000001
PASS: DEC A timing = 2 cycles
PASS: DEC A: $10 -> $0F = 0000000f
PASS: DEC A: $01 -> $00 = 00000000
PASS: DEC A zero Z=1 = 00000001
PASS: DEC A: $00 -> $FF = 000000ff
PASS: DEC A wrap N=1 = 00000001

=== SECTION 39: CMOS PHX/PHY/PLX/PLY ===

PASS: PHX timing = 3 cycles
PASS: PHX: stack[$01FD] = $5A = 0000005a
PASS: PHX: S = $FC = 000000fc
PASS: PHY timing = 3 cycles
PASS: PHY: stack[$01FD] = $A5 = 000000a5
PASS: PHY: S = $FC = 000000fc
PASS: PLX timing = 4 cycles
PASS: PLX: X = $91 = 00000091
PASS: PLX: S = $FC = 000000fc
PASS: PLX N=1 = 00000001
PASS: PLX Z=0 = 00000000
PASS: PLX zero: X = $00 = 00000000
PASS: PLX Z=1 = 00000001
PASS: PLY timing = 4 cycles
PASS: PLY: Y = $42 = 00000042
PASS: PLY: S = $FC = 000000fc
PASS: PLY N=0 = 00000000

=== SECTION 40: CMOS STZ ===

PASS: STZ zp timing = 3 cycles
PASS: STZ zp: ram[$40] = $00 = 00000000
PASS: STZ zp,X timing = 4 cycles
PASS: STZ zp,X: ram[$45] = $00 = 00000000
PASS: STZ abs timing = 4 cycles
PASS: STZ abs: ram[$0080] = $00 = 00000000
PASS: STZ abs,X timing = 5 cycles
PASS: STZ abs,X: ram[$0083] = $00 = 00000000
PASS: STZ preserves P = 000000a5

=== SECTION 41: CMOS TRB / TSB ===

PASS: TRB zp timing = 5 cycles
PASS: TRB zp: $FF & ~$0F = $F0 = 000000f0
PASS: TRB zp Z=0 (FF & 0F != 0) = 00000000
PASS: TRB zp no-clear: $0F & ~$F0 = $0F = 0000000f
PASS: TRB zp Z=1 ($0F & $F0 == 0) = 00000001
PASS: TRB abs timing = 6 cycles
PASS: TRB abs: $AA & ~$0A = $A0 = 000000a0
PASS: TSB zp timing = 5 cycles
PASS: TSB zp: $0F | $F0 = $FF = 000000ff
PASS: TSB zp Z=1 ($0F & $F0 == 0) = 00000001
PASS: TSB zp no-set: $0F | $08 = $0F = 0000000f
PASS: TSB zp Z=0 ($0F & $08 != 0) = 00000000
PASS: TSB abs timing = 6 cycles
PASS: TSB abs: $12 | $C0 = $D2 = 000000d2

=== SECTION 42: CMOS BIT Extensions ===

PASS: BIT # timing = 2 cycles
PASS: BIT # Z=1 ($F0 & $0F == 0) = 00000001
PASS: BIT # N preserved (0) = 00000000
PASS: BIT # V preserved (0) = 00000000
PASS: BIT # Z=0 ($0F & $08 != 0) = 00000000
PASS: BIT # N preserved (1) = 00000001
PASS: BIT # V preserved (1) = 00000001
PASS: BIT zp,X timing = 4 cycles
PASS: BIT zp,X N=1 (M[7]) = 00000001
PASS: BIT zp,X V=1 (M[6]) = 00000001
PASS: BIT zp,X Z=1 ($0F & $C0 == 0) = 00000001
PASS: BIT abs,X no-cross timing = 4 cycles
PASS: BIT abs,X N=1 = 00000001
PASS: BIT abs,X V=0 = 00000000
PASS: BIT abs,X Z=0 ($81 & $81 != 0) = 00000000

=== SECTION 43: CMOS JMP (abs,X) ===

PASS: JMP (abs,X) timing = 6 cycles
PASS: JMP ($1500,X=0): PC = $1733 = 00001733
PASS: JMP (abs,X) X=4 timing = 6 cycles
PASS: JMP ($1500,X=4): PC = $1866 = 00001866
PASS: JMP (abs,X) page-cross timing = 6 cycles
PASS: JMP ($15FE,X=2) cross: PC = $1999 = 00001999

=== SECTION 44: CMOS (zp) Indirect ===

PASS: LDA (zp) timing = 5 cycles
PASS: LDA ($50): A = $77 = 00000077
PASS: STA (zp) timing = 5 cycles
PASS: STA ($50): ram[$01F0] = $AB = 000000ab
PASS: ORA (zp) timing = 5 cycles
PASS: ORA ($50): A = $FF = 000000ff
PASS: AND ($50): A = $03 = 00000003
PASS: EOR ($50): A = $55 = 00000055
PASS: ADC ($50): A = $30 = 00000030
PASS: CMP ($50): equal Z=1 = 00000001
PASS: CMP ($50): equal C=1 = 00000001
PASS: SBC ($50): A = $20 = 00000020
PASS: LDA ($FF) ZP wrap: A = $99 = 00000099

=== SECTION 45: CMOS RMB / SMB ===

PASS: RMB0 timing = 5 cycles
PASS: RMB0: $FF -> $FE = 000000fe
PASS: RMB0 preserves P = 000000a5
PASS: RMB3: $FF -> $F7 = 000000f7
PASS: RMB7: $FF -> $7F = 0000007f
PASS: RMB1 already-clear: $F0 -> $F0 = 000000f0
PASS: SMB0 timing = 5 cycles
PASS: SMB0: $00 -> $01 = 00000001
PASS: SMB0 preserves P = 000000a5
PASS: SMB4: $00 -> $10 = 00000010
PASS: SMB7: $00 -> $80 = 00000080
PASS: SMB1 already-set: $0F -> $0F = 0000000f
PASS: RMBn sweep: bit cleared correctly = 000000fe
PASS: RMBn sweep: bit cleared correctly = 000000fd
PASS: RMBn sweep: bit cleared correctly = 000000fb
PASS: RMBn sweep: bit cleared correctly = 000000f7
PASS: RMBn sweep: bit cleared correctly = 000000ef
PASS: RMBn sweep: bit cleared correctly = 000000df
PASS: RMBn sweep: bit cleared correctly = 000000bf
PASS: RMBn sweep: bit cleared correctly = 0000007f
PASS: SMBn sweep: bit set correctly = 00000001
PASS: SMBn sweep: bit set correctly = 00000002
PASS: SMBn sweep: bit set correctly = 00000004
PASS: SMBn sweep: bit set correctly = 00000008
PASS: SMBn sweep: bit set correctly = 00000010
PASS: SMBn sweep: bit set correctly = 00000020
PASS: SMBn sweep: bit set correctly = 00000040
PASS: SMBn sweep: bit set correctly = 00000080

=== SECTION 46: CMOS BBR / BBS ===

PASS: BBR0 taken timing = 6 cycles
PASS: BBR0 bit clear: branch taken = 00001108
PASS: BBR0 not-taken timing = 5 cycles
PASS: BBR0 bit set: PC = $1103 = 00001103
PASS: BBS7 taken timing = 6 cycles
PASS: BBS7 bit set: PC = $110B = 0000110b
PASS: BBS7 not-taken timing = 5 cycles
PASS: BBS7 bit clear: PC = $1103 = 00001103
PASS: BBR fwd cross timing = 7 cycles
PASS: BBR fwd cross: PC = $1113 = 00001113
PASS: BBS back no-cross timing = 6 cycles
PASS: BBS -5: PC = $111E = 0000111e
PASS: BBRn sweep all clear: PC = $1103 = 00001103
PASS: BBRn sweep all clear: PC = $1103 = 00001103
PASS: BBRn sweep all clear: PC = $1103 = 00001103
PASS: BBRn sweep all clear: PC = $1103 = 00001103
PASS: BBRn sweep all clear: PC = $1103 = 00001103
...
PASS: BBRn sweep all clear: PC = $1103 = 00001103
PASS: BBRn sweep all clear: PC = $1103 = 00001103
PASS: BBSn sweep all set: PC = $1103 = 00001103
PASS: BBSn sweep all set: PC = $1103 = 00001103
PASS: BBSn sweep all set: PC = $1103 = 00001103
PASS: BBSn sweep all set: PC = $1103 = 00001103
PASS: BBSn sweep all set: PC = $1103 = 00001103
...
PASS: ADC BCD 25+75 = 00 BCD q = 00
PASS: ADC BCD Z=1 (decimal $00) = 1
PASS: ADC BCD C=1 (decimal carry) = 1
PASS: ADC BCD 45+45 = 90 BCD q = 90
PASS: ADC BCD N=1 (high nibble 9) = 1
PASS: SBC BCD 50-50 = 00 BCD q = 00
PASS: SBC BCD Z=1 (decimal $00) = 1
PASS: SBC BCD 00-01 = 99 BCD (borrow) q = 99
PASS: SBC BCD N=1 (high nibble 9) = 1
